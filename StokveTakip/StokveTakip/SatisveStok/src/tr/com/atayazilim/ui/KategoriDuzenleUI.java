...
import tr.com.atayazilim.dal.KategoriDAL;
...
public class KategoriDuzenleUI extends JDialog implements uiInterfaces {
	...
	public JPanel initPanel() {
		...
		ustPanel.setBorder(BorderFactory.createTitledBorder("Kategoriyi D�zenle"));
		...
		JLabel ustkategoriLabel = new JLabel("�st Kategorisi:",JLabel.RIGHT);
		...
		JLabel yeniAdLabel = new JLabel("Yeni Kategori Ad�:",JLabel.RIGHT);
		...
		ustPanel.setBorder(BorderFactory.createTitledBorder("D�zenlenecek Liste"));
		...
		duzenleButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Ba�ar�l� bir �ekilde kategori g�ncellendi.");
